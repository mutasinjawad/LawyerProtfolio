...
return (
    ...
    <Element className="flex flex-col items-center justify-center xl:m-16 xl:mb-36 lg:mb-24 mb-0 lg:m-8 mx-10 xl:h-[65vh] lg:h-[62vh]" name="contact">
        ...
        <div className='relative flex flex-col items-center justify-between h-full'>
            ...
            {/* Contact Box */}
            <div className="flex lg:flex-row flex-col justify-center items-start xl:w-[140vh] lg:w-[100vh] w-full lg:gap-16 gap-6 lg:mb-0 mb-8 lg:mt-14 mt-8">
