...
return (
    ...
    <Element className="flex justify-center xl:pt-10 xl:h-[800px] lg:pt-8 lg:h-[700px] md:h-[1000px] h-[980px] pt-16 mb-2" name="about">
        <div className='flex lg:flex-row flex-col-reverse gap-y-4 items-center justify-center xl:w-[1310px] lg:w-[1060px] md:w-[800px] w-[680px] h-full xl:px-8 md:px-8 px-12'>
            
            {/* Photos & Help */}
            <div className='flex flex-col lg:w-2/3 lg:h-full md:w-full md:h-[65%] w-full h-[50%] gap-2 lg:items-start justify-center lg:pr-3'>
                {/* Photos */}
                <div className='w-full xl:h-2/3 lg:h-3/5 md:h-2/3 h-[60%] rounded-[5px] overflow-hidden'>
                    <ImageSlider images={images} />
                </div>

                {/* Help */}
                <form class="w-full xl:h-1/3 lg:h-2/5 md:h-1/3 h-[40%] bg-white rounded-[5px] xl:p-4 md:p-3 p-2">
                    ...
                    <div className="w-full h-full mb-1">
                        <textarea 
                            ...
                            className="w-full xl:h-[150px] lg:h-[170px] md:h-[100px] h-[60px] resize-none border-[1px] border-neutral-300 rounded-[5px] font-rregular xl:text-sm md:text-[13px] focus:border-[#404030] focus:outline-none xl:px-2 xl:pt-2 md:px-2 md:py-2 px-2 py-1 text-[12px]"
                        />
                    </div>
                </form>
            </div>
            ...
            <div className='flex lg:flex-col md:flex-row flex-col lg:w-1/3 lg:h-full h-[50%] md:h-[35%] gap-2'>
                ...
                <div className='lg:h-4/6 flex flex-col lg:items-center items-start justify-between gap-2 bg-accent rounded-[5px] xl:p-4 md:p-3 p-2'>
                    ...
                    <div className='flex gap-2 md:gap-2'>
                        <img
                            src={Lawyer}
                            alt="Lawyer"
                            className="xl:w-[180px] lg:w-[120px] md:w-[130px] w-[90px] xl:rounded-2xl md:rounded-xl rounded-lg"
                        />
                ...
                {/* Members */}
                {/* <div className="w-full lg:h-2/6 bg-white rounded-[5px] xl:p-4 md:p-3 p-2">
