            ...
            <div className='flex flex-col items-center justify-between gap-6 xl:w-[1310px] w-full xl:px-8 md:px-8 sm:px-8 xs:px-6 px-2'>
                <div className='flex flex-col items-start'>
                    ...
                    <div className="flex flex-col items-start w-full p-2 text-black bg-white shadow-sm lg:p-6 md:p-4 xs:p-3 rounded-xl">
                        <h1 className="font-rbold mb-6 text-primary xl:text-[18px]">Constitutional Law</h1>
                        ...
                        <p className="leading-relaxed xl:font-rlight font-rregular xl:text-[15px] lg:text-[12px] md:text-sm sm:text-[12px] xs:text-[11px] text-[10px]">
                            I provide specialist advisory, drafting, and advocacy services in matters related to Constitutional Law. If your fundamental rights have been violated or you are seeking protection under the Constitution of Bangladesh, I can assist you by offering legal guidance and representing you before courts and tribunals.
                        </p>
                    </div>
                </div>
