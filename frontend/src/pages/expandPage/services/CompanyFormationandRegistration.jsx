...
const CompanyFormationandRegistration = () => {
            ...
            <div className='flex flex-col items-center justify-between gap-6 xl:w-[1310px] w-full xl:px-8 md:px-8 sm:px-8 xs:px-6 px-2'>
                <div className='flex flex-col items-start'>
                    ...
                    <div className="flex flex-col items-start w-full p-2 text-black bg-white shadow-sm lg:p-6 md:p-4 xs:p-3 rounded-xl">
                        <h1 className="font-rbold mb-6 text-primary xl:text-[18px]">Company Formation and Registration</h1>
                        ...
                        <p className="mb-4 leading-relaxed xl:font-rlight font-rregular xl:text-[15px] lg:text-[12px] md:text-sm sm:text-[12px] xs:text-[11px] text-[10px]">
                            If you are planning to register a new company or relocate an existing business to Bangladesh, I can assist you throughout the entire process. In Bangladesh, a private limited company is recognized as a separate legal entity, and its shareholders are not personally liable for the company’s debts beyond the value of their share capital. Under the Companies Act 1994, any individual—local or foreign—aged 18 or above is eligible to register a company.
                        </p>

                        <p className="mb-2 leading-relaxed xl:font-rlight font-rregular xl:text-[15px] lg:text-[12px] md:text-sm sm:text-[12px] xs:text-[11px] text-[10px]">
                            To incorporate a company in Bangladesh, the following documents and information are required by the Registrar of Joint Stock Companies and Firms (RJSC):
                        </p>
                        <ul className='pl-5 space-y-2 list-disc'>
                            <li className="leading-relaxed xl:font-rlight font-rregular xl:text-[15px] lg:text-[12px] md:text-sm sm:text-[12px] xs:text-[11px] text-[10px]">
                                <span className='font-rbold'>Company Name:</span> A name clearance must be obtained in advance.
                            </li>
                            <li className="leading-relaxed xl:font-rlight font-rregular xl:text-[15px] lg:text-[12px] md:text-sm sm:text-[12px] xs:text-[11px] text-[10px]">
                                <span className="font-semibold">Memorandum and Articles of Association (MoA & AoA):</span> The object clause in the MoA must be within 400 words and limited to 7 clauses.
                            </li>
                            <li className="leading-relaxed xl:font-rlight font-rregular xl:text-[15px] lg:text-[12px] md:text-sm sm:text-[12px] xs:text-[11px] text-[10px]">
                                <span className="font-semibold">Shareholders’ Information:</span> Including National ID for Bangladeshi shareholders.
                            </li>
                            <li className="leading-relaxed xl:font-rlight font-rregular xl:text-[15px] lg:text-[12px] md:text-sm sm:text-[12px] xs:text-[11px] text-[10px]">
                                <span className="font-semibold">Directors’ Information:</span> Including Tax Identification Number (TIN).
                            </li>
                            <li className="leading-relaxed xl:font-rlight font-rregular xl:text-[15px] lg:text-[12px] md:text-sm sm:text-[12px] xs:text-[11px] text-[10px]">
                                <span className="font-semibold">Registered Office Address</span>
                            </li>
                            <li className="leading-relaxed xl:font-rlight font-rregular xl:text-[15px] lg:text-[12px] md:text-sm sm:text-[12px] xs:text-[11px] text-[10px]">
                                <span className="font-semibold">Signed Form IX and Subscriber Page:</span> A scanned PDF copy is required.
                            </li>
                            <li className="leading-relaxed xl:font-rlight font-rregular xl:text-[15px] lg:text-[12px] md:text-sm sm:text-[12px] xs:text-[11px] text-[10px]">
                                <span className="font-semibold">For Foreign Nationals:</span> A copy of passport for each shareholder and director.
                            </li>
                        </ul>
                    </div>
                </div>
