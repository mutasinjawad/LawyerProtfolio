            ...
            <div className='flex flex-col items-center justify-between gap-6 xl:w-[1310px] w-full xl:px-8 md:px-8 sm:px-8 xs:px-6 px-2'>
                <div className='flex flex-col items-start'>
                    ...
                    <div className="flex flex-col items-start w-full p-2 text-black bg-white shadow-sm lg:p-6 md:p-4 xs:p-3 rounded-xl">
                        <h1 className="font-rbold mb-6 text-primary xl:text-[18px]">Commercial Litigation</h1>
                        ...
                        <p className="mb-4 leading-relaxed xl:font-rlight font-rregular xl:text-[15px] lg:text-[12px] md:text-sm sm:text-[12px] xs:text-[11px] text-[10px]">
                            I provide specialist advisory, drafting, and advocacy services in a wide range of commercial matters. My practice covers virtually every type of dispute that can arise in a business context, including commercial litigation involving breach of contract, partnership or joint venture disputes, shareholder conflicts, and allegations of breach of fiduciary duty.
                        </p>
                        ...
                        <p className="leading-relaxed xl:font-rlight font-rregular xl:text-[15px] lg:text-[12px] md:text-sm sm:text-[12px] xs:text-[11px] text-[10px]">
                            Whether you're facing a complex commercial disagreement or a straightforward contractual issue, I offer practical legal advice and courtroom representation tailored to your business needs. My aim is to resolve disputes efficiently—through negotiation, mediation, or litigation—while protecting your interests every step of the way.
                        </p>
                    </div>
                </div>
