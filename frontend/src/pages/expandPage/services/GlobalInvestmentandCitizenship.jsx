...
const GlobalInvestmentandCitizenship = () => {
            ...
            <div className='flex flex-col items-center justify-between gap-6 xl:w-[1310px] w-full xl:px-8 md:px-8 sm:px-8 xs:px-6 px-2'>
                <div className='flex flex-col items-start'>
                    ...
                    <div className="flex flex-col items-start w-full p-2 text-black bg-white shadow-sm lg:p-6 md:p-4 xs:p-3 rounded-xl">
                        <h1 className="font-rbold mb-6 text-primary xl:text-[18px]">Global Investment and Citizenship</h1>
                        ...
                        <p className="mb-4 leading-relaxed xl:font-rlight font-rregular xl:text-[15px] lg:text-[12px] md:text-sm sm:text-[12px] xs:text-[11px] text-[10px]">
                            A growing number of countries now offer immigrant investor programs, granting residence or citizenship in exchange for a significant investment in their economies.
                        </p>
                        ...
                        <p className="leading-relaxed xl:font-rlight font-rregular xl:text-[15px] lg:text-[12px] md:text-sm sm:text-[12px] xs:text-[11px] text-[10px]">
                            I assist valuable clients, including potential businesspeople and students, who wish to invest lawfully and pursue studies in another country for permanent residency or a passport. This allows them to travel abroad more easily, especially to countries offering better passports or permits.
                        </p>
                    </div>
                </div>
...
export default GlobalInvestmentandCitizenship;
