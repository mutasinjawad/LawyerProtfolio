            ...
            <div className='relative flex flex-col items-center justify-between lg:m-36 mx-12 mb-16 lg:h-[70vh]'>
                ...
                <div className="flex lg:flex-row flex-col justify-center items-center w-full lg:gap-16 gap-6 lg:mb-0 mb-8 lg:mt-0 mt-16">
                    <Swiper
                        ...
                        >
                        {blogs.map((blogs) => (
                        <SwiperSlide key={blogs.id} className='lg:pl-24 pb-14 z-0'>
                            <div key={blogs.id} className="lg:h-[38vh] h-[23vh] w-[30vh] bg-white rounded-3xl hover:bg-primary-100 hover:shadow cursor-pointer transition-all duration-300 ease-in-out">
                                <div className="lg:p-10 p-6 lg:h-[30vh] h-[18vh]" style={{
                                    overflow:"hidden"
                                    }}>
                                    <h3 className="font-pmedium lg:text-[20px] text-[18px]">{blogs.title}</h3>
                                    <p className="font-pregular text-gray-500 lg:text-[18px] text-[15px]">{fomratDate(blogs.date_published)}</p>
                                    <p className="font-pregular pt-10 lg:text-[18px] text-[15px]">{blogs.description}</p>
                                </div>
