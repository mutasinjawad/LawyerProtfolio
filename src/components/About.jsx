...
const About = () => {
  return (
    <div className="flex flex-col-reverse lg:flex-row items-center justify-between lg:m-36 m-12 lg:h-[70vh]">
        ...
        <div className="text-left lg:w-2/5 lg:p-0 p-6">
            <h1 className="font-pmedium lg:text-[60px] text-[35px] text-black leading-[1.0] lg:mb-2 mb-4 lg:mt-0 mt-[60px]">Biplab Kumar Poddar</h1>
            <h2 className="font-pregular lg:text-[23px] text-[18px] text-black lg:mb-10 mb-8">Advocate, Supreme Court of Bangladesh</h2>
            <p className="font-plight lg:text-[20px] text-[15px] text-black-200 lg:mb-16 mb-12">
        ...
        <div className="flex relative justify-center items-center lg:w-auto w-full">
            <div className="lg:hidden absolute left-6 flex flex-col justify-start space-y-12">
            ...
            <div className="lg:m-16 m-6">
                <img
                    src={Lawyer}
                    alt="Lawyer"
                    className="lg:w-[40vh] w-[23vh] rounded-full"
                />
            </div>
        </div>
    </div>
